...
if(e.getSource()==b2){flag=0;
     flag=0;x=0;y=0;
     p=0;
     q=0;r=0;s=0;t=0;u=0;v=0;w=0;z=0;
...
if(x>=200&&x<=300 &&y<=200&&y>=100){p++;flag2++;
...
if(x2>=300&&x2<=500 &&y2<=200&&y2>=100){q++;flag2++;
    ...
    if(x3>=500&&x3<=800 &&y3<=200&&y3>=100){r++;flag2++;
        ...
        if(x4>=200&&x4<=300 &&y4<=350&&y4>=200){s++;flag2++;
            ...
            if(x5>=300&&x5<=500 &&y5<=350&&y5>=200){t++;flag2++;
                ...
                if(x6>=500&&x6<=700 &&y6<=350&&y6>=200){u++;flag2++;
                    ...
                    if(count6%2!=0&&flag==2){p6++;
                        ...
                        else if(count6%2==0&&flag==2){p6++;
                            g.drawOval(510,240,80,80);
                        }
                    }
                    if(x7>=200&&x7<=300 &&y7>=350&&y7<=500){v++;flag2++;
...
if(x8>=300&&x8<=500 &&y8>=350&&y8<=500){w++;flag2++;
...
if(x9>=500&&x9<=800 &&y9>=350&&y9<=500){z++;flag2++;
...
if(x>=200&&x<=300 &&y<=200&&y>=100&&x5>=300&&x5<=500 &&y5<=350&&y5>=200&&x9>=500&&x9<=800 &&y9>=350&&y9<=500&&o1>=1&&o5>=1&&o9>=1){
    win=1;
    if(flag==1)
    g.drawString("Winner is "+s1,300,550);
    else
    g.drawString("Winner is "+s2,300,550);
    ...
    q=1;r=1;s=1;u=1;v=1;w=1;
        ...
        g.drawString("Winner is "+s2,300,550);
       // g.drawString("Winner is X",300,550);
        g.drawLine(200,100,600,440);
        q=1;r=1;s=1;u=1;v=1;w=1;
        }  
            ...
            g.drawString("Winner is "+s2,300,550);
       //     g.drawString("Winner is O",300,550);
        ...
        p=1;q=1;s=1;u=1;w=1;z=1;
           ...
           if(x>=200&&x<=300 &&y<=200&&y>=100&&x4>=200&&x4<=300 &&y4<=350&&y4>=200&&x7>=200&&x7<=300 &&y7>=350&&y7<=500&&o1>=1&&o4>=1&&o7>=1){
            win=1;
             if(flag==1)
            g.drawString("Winner is "+s1,300,550);
            else
